...
$sql_product = "INSERT INTO product (product_name, product_all,product_class, product_website,product_img_url,product_wap_img_url,product_wap_show_img_url) VALUES ( '{$product_name}', '{$product_all}', '{$product_class}', '{$product_website}','{$img_pc_url}','{$img_wap_url}','{$img_wap_show_url}')";
